...
namespace _08._10._2019
{
    class qwerty
    {
        ...
        public void Start()
        {
            for (int i = 0; i < 30; i++)
            {
                products.Add(new Product("name" + rnd.Next(0, 10), (decimal)(rnd.Next(150, 1500) * MathF.PI), new DateTime(rnd.Next(2015, 2019), rnd.Next(1, 12), rnd.Next(1, 28)), "Country" + rnd.Next(0, 5), rnd.Next(0, 5),rnd.Next(10,20)));
            }
        ...
        public void  Linq()
        {
            ...
            using (FileStream fs = new FileStream("products.bin", FileMode.OpenOrCreate))
            {
